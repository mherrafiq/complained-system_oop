...
{
    public partial class Complain2 : Form
    {
        public Complain2()
        {
            InitializeComponent();
        ...
        public void getdata()
        {
            ...
            {
                complaint += "Rude behaviour of MNA/MPA donot listen to queries.\n";
            }
            if (checkBox2.Checked == true)
            {
                complaint += "Lack of interest towards development work in locality\n";
            }
            if (checkBox3.Checked == true)
            {
                complaint += "Disturb using noisy loud speaker for political activities\n";
            }
            if (checkBox4.Checked == true)
            {
                complaint += "Block roads and paths for personal event\n";
            }
            if (checkBox5.Checked == true)
            {
                complaint += "Miss use of power and authorities \n";
            }
        ...
        private void Complain2_Load(object sender, EventArgs e)
        {
        ...
        private void Complain2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
